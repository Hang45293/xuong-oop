...
@section('content')
    ...
    <form action="{{ url('admin/products/store') }}" enctype="multipart/form-data" method="POST">
        <div class="row">
            ...
            <!-- đây nè , sửa thêm giá tiền vào , giá tiền mặc định k đucợ null -->
            <div class="mb-3 mt-3">
                    <label for="img_thumbnail" class="form-label">Price Regular:</label>
                    <input type="text" class="form-control" id="price_regular" placeholder="Enter price_regular" name="price_regular">
                </div>
                <!-- đây nè , sửa thêm giá tiền vào , giá tiền mặc định k đucợ null -->
                <!-- <div class="mb-3 mt-3">
                    <label for="img_thumbnail" class="form-label">Price Regular:</label>
                    <input type="file" class="form-control" id="price_regular" placeholder="Enter price_regular" name="price_regular">
                </div> -->
